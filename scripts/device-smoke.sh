...
adb install -r dist/ArrowEscape-PuzzleMaze-V17-test.apk
adb install -r dist/ArrowEscape-V17-tests.apk
...
assert result and int(result.group(1))>=4 and 'FAILURES' not in s, s
PY

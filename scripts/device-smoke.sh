...
adb install -r dist/ArrowEscape-PuzzleMaze-V20-test.apk
adb install -r dist/ArrowEscape-V20-tests.apk
...
assert result and int(result.group(1))>=11 and 'FAILURES' not in s, s
PY
